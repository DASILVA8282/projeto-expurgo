    ...
    <div className="w-full max-w-3xl mx-auto">
      <div className="bg-slate-900 rounded-lg p-6 border border-cyan-500/20">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-cyan-400 font-orbitron font-bold text-lg">ATRIBUTOS</h3>
        ...
        {!readonly && (
          <div className="mt-6 w-full max-w-4xl">
            <h4 className="text-cyan-400 font-orbitron font-bold text-lg mb-6 text-center">AJUSTAR ATRIBUTOS</h4>
            
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/* Atributos Físicos */}
              <div className="bg-slate-800/50 rounded-lg p-4 border border-blue-500/20">
                <h5 className="text-blue-400 font-orbitron font-bold text-sm mb-4">FÍSICOS</h5>
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <input
                      ...
                      style={{
                        background: `linear-gradient(to right, #3b82f6 0%, #3b82f6 ${stats.speed}%, #475569 ${stats.speed}%, #475569 100%)`
                      }}
                    />
                    <span className="text-xs text-blue-400 font-orbitron font-bold min-w-[30px]">
                      {stats.speed}
                    </span>
                  </div>
              ...
              <div className="bg-slate-800/50 rounded-lg p-4 border border-red-500/20">
                <h5 className="text-red-400 font-orbitron font-bold text-sm mb-4">TÉCNICOS</h5>
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <label className="text-xs text-slate-300 font-orbitron font-bold min-w-[100px]">
                      CHUTE:
